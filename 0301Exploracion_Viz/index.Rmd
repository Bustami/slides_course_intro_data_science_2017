...
```{r message=F, warning=F, results=T, error=F, fig.width=6, fig.height=6}
...
```{r message=F, warning=F, results=T, error=F, fig.width=8, fig.height=5}
...
```{r message=F, warning=F, results=T, error=F, fig.width=12, fig.height=6}
...
```{r message=F, warning=F, results=T, error=F, fig.width=8, fig.height=6}
